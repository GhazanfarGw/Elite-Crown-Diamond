            ...
            <div className='mx-auto text-[#fff] lg:grid-cols-2 lg:flex gap-x-20 items-center'>
                ...
                <div className='lg:max-w-lg lg:pt-5 pt-10 pb-8'>
                    ...
                    <p className='pt-3 tracking-wide text-sm md:text-xl text-[#e0e0e0]'>
                        Elite Crown Diamond is a leading business that invests in  different assets classes mainly fintech and health tech companies. 
                        ...
                        Elite Crown will keep working around the clock to provide the best advice to our family & friends.
                    </p>
                </div>
