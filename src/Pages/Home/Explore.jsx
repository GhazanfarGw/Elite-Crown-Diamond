...
//             </h1>
//             <p className='pt-5 font-light h-44 text-justify px-2'>
//               Elite Crown Diamond Digital Art studio have the Master – level Skills , process and mindset of professional digital artists to bring your imagination into reality.
//             </p>
            ...
            <div className='mx-auto justify-center'>
                ...
                <div className='lg:grid lg:grid-cols-3 mx-auto justify-center md:gap-5 md:pt-10'>
                    ...
                    <div className={`transition-transform transform hover:scale-105 duration-300 cursor-pointer md:mt-0 mt-5 py-6 px-6 bg-[#1F1F1F] hover:bg-[#2b2b2b]`}>
                        ...
                        <p className='md:text-base text-sm tracking-wide text-[#e0e0e0]'>
                          Elite Crown Diamond is spearheading the electric mobility revolution with its state-of-the-art EV Charging Infrastructure venture. Recognizing the transformative potential of robust charging networks,
                        </p>
                        <br/>
