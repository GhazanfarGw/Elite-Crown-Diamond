    ...
    return (
        <div className='mt-10'>
            <div className='max-w-screen-xl mx-auto justify-center md:py-10 md:px-10 pb-10 px-5'>
                ...
                <div className='md:grid md:grid-cols-4 md:gap-x-20 md:max-w-7xl mx-auto justify-center py-5 text-black'>
                    <div className="py-2 md:px-0">
                        ...
                        <h1 className='text-black text-base justify-center font-semibold'>
                            Community
                        </h1>
                        <div className="flex flex-row gap-7 pt-5">
                            <a 
                                ...
                                rel="noreferrer">
                                <svg
                                    xmlns="http://www.w3.org/2757575/svg"
                            ...
                            <a 
                                ...
                                rel="noreferrer">
                                    ...
                                    width="19.757575pt" viewBox="0 0 100.757575 100.757575"
                                    preserveAspectRatio="xMidYMid meet">
                                    <g transform="translate(0.757575,100.757575) scale(0.175757500,-0.175757500)"
                    ...
                    <div className='pt-9'>
                        ...
                        <div className='pt-4'>
                            <div>
                                <a 
                                    className='text-sm text-[#757575] md:pt-4 pt-2 hover:text-[#d8bb6c] hover:font-semibold duration-150' 
                                    href="#home"
                                >
                                    Home
                                </a>
                ...
                <div className='justify-center mx-auto md:text-center md:px-5 md:pb-5'>
                    <div className='border-b border-[#d8bb6c]'/>
                        <p className='text-xs text-[#757575] pt-5'>
