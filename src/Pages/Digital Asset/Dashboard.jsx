    ...
    <>
        <div className='duration-500'>
            <div className='bg-local md:h-24 px-5 pt-20 md:pt-0 md:px-0'>
                <img className='z-0 duration-500 w-full object-cover md:h-[44rem]' src='./34.jpg' alt='image'/>
            </div>
            <div className='hidden md:block lg:block md:px-16 mx-auto justify-center overflow-hidden px-5 md:text-center'>
                <div className='text-white md:py-20 mt-5 md:mt-16 md:pb-0'>
